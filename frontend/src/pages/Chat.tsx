            ...
            {history.length === 0 ? (
              ...
              history.map((item) => (
                <button
                  ...
                  className="w-full text-left p-3 hover:bg-gray-800 border-b border-gray-700/50"
                >
        ...
        <div className="px-4 py-4 bg-gray-900 border-t border-gray-700">
          <div className="flex gap-3 max-w-4xl mx-auto">
            <textarea
              ...
              placeholder={hasDocuments === false ? 'Upload documents first to enable the chat...' : 'Ask about Formula 1... (Enter to send)'}
